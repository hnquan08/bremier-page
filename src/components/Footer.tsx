...
export default function Footer() {
  ...
  return (
    <div className="bg-primary lg:h-screen lg:shrink-0 lg:snap-start">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <p className="mt-4 text-light text-xl">{t('footer.logo.follow')}</p>

            <div className="flex flex-row gap-4 mt-4">
              <div className="text-light transition hover:opacity-75 cursor-pointer">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3 text-center lg:text-left">
            <div>
              <p className="font-medium text-light text-xl">
                {t('footer.page.title')}
              </p>
